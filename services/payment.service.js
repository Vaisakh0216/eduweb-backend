...
//       if (existingPayment) {
//         throw new AppError(
//           `Payment with transaction reference '${data.transactionRef}' already exists`,
//           400
//         );
//       }
//     }
...
//     const admission = await Admission.findById(data.admissionId).populate(
//       "branchId",
//       "code"
//     );
//     if (!admission) {
...
//     console.log(
//       "deductServiceCharge value:",
//       data.deductServiceCharge,
//       "type:",
//       typeof data.deductServiceCharge
//     );
...
//           if (
//             data.serviceChargeDeducted !== undefined &&
...
//       );
//       console.log(
//         "Consultancy SC portion (deducted from transfer):",
...
//     console.log(
//       "Final values - serviceChargeDeducted:",
//       serviceChargeDeducted,
//       "amountDueToCollege:",
//       amountDueToCollege,
//       "agentFeeDeducted:",
...
//       amountDueToCollege,
//       agentFeeDeducted,
//       amountTransferredToConsultancy: isAgentToConsultancy
...
//       agentIdForFeePayment: isConsultancyToAgent
//         ? data.agentIdForFeePayment
//         : null,
...
//       {
//         path: "admissionId",
//         select: "admissionNo student.firstName student.lastName",
//       },
...
//         .populate(
//           "admissionId",
//           "admissionNo student.firstName student.lastName"
//         )
  ...
  async create(data, createdBy) {
    ...
    if (data.receiverType === RECEIVER_TYPES.CONSULTANCY) {
      ...
      if (existingDaybookEntry) {
        throw new AppError("A daybook entry already exists for this payment", 409);
      }
      ...
      if (account === "Cash") {
        ...
        if (existingCashbookEntry) {
          throw new AppError("A cashbook entry already exists for this voucher", 409);
        }
