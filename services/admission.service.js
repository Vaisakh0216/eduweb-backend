...
class AdmissionService {
  ...
  async updatePaymentSummary(admissionId, paymentInfo = null) {
    ...
    // deductedFromStudent = SC kept directly by consultancy from student payments.
    // collectedByAgent = SC collected separately by agent (outside payments, tracked via journal).
    // These are SEPARATE — do NOT subtract one from the other.
